...
std::map<GSyst_t, std::string> GSyst::BuildGSystToStringMap() {
  ...
  temp_map[ kINukeTwkDial_MFPLoE_N ]        = "MFPLoE_N";
  temp_map[ kINukeTwkDial_MFPM1E_N ]        = "MFPM1E_N";
...
//temp_map[ kINukeTwkDial_FrElas_pi ]       = "FrElas_pi";
  ...
  temp_map[ kINukeTwkDial_G4_N ]            = "FrG4_N";
  temp_map[ kINukeTwkDial_INCL_N ]          = "FrINCL_N";
  temp_map[ kINukeTwkDial_G4LoE_N ]         = "FrG4LoE_N";
  temp_map[ kINukeTwkDial_INCLLoE_N ]       = "FrINCLLoE_N";
  temp_map[ kINukeTwkDial_G4M1E_N ]         = "FrG4M1E_N";
  temp_map[ kINukeTwkDial_INCLM1E_N ]       = "FrINCLM1E_N";
  temp_map[ kINukeTwkDial_G4M2E_N ]         = "FrG4M2E_N";
  temp_map[ kINukeTwkDial_INCLM2E_N ]       = "FrINCLM2E_N";
